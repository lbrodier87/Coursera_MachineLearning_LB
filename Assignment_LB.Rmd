...
```
#Conclusion: 
The random forest model is better with an accuracy of `r accurary.rf` compared to the decision tree with an accuracy of `r accuracy.dt`. We keep the random forest model. 